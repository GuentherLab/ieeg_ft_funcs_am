...
switch proj_str
    case 'DBS' % Pitt
        ...
        ARTIFACT_FILENAME_SUB = [PATH_ANNOT filesep op.sub '_artifact_criteria_', op.art_crit, '_not-denoised.txt']; 
    ...
    case 'DM' % MGH
        ...
        % filepath and filename for saving artifact info into subject-specific annot folder
        ARTIFACT_FILENAME_SUB = [PATH_ANNOT filesep 'sub-' op.sub '_ses-' SESSION '_task-' TASK '_artifact-criteria-' ARTIFACT_CRIT '_not-denoised.tsv'];
