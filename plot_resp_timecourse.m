...
ntrials = height(timecourses_unaligned);
 ...
 trtimecourses_unalignedials_tmp = [timecourses_unaligned, table(nans_tr,              nans_tr,...
...
if ~isempty(sort_cond)
    ...
    else % remove empty condition labels... probably occurs for unusable trials (e.g. no speech)
