...
%for sub=1:length(triplet_subjects)
    ...
    timepoints = zeros(length(annot_end),2,length(FT_file.trial)); % each row is a trial; first column is start location; second column is end location; z axis is session
